...
<body class="bg-primary">
  ...
  <section class="py-5 mt-3 container">
    <a href="ingreso_asignatura.html"> <button type="button" class="btn btn-dark"> Ingresar Asignaturas </button>  </a>
  </section>
        ...
        foreach ($productos as $producto) { ?>
          ...
          <div class="jumbotron py-3">
            ...
            <p class="lead text-center">
              <a class="btn btn-primary btn-lg" href="contenidos_admin.php?id=<?php echo $producto['id_asignatura'] ?>"> ACCEDER</a>
            </p>
            <hr class="my-2">
          </div>
