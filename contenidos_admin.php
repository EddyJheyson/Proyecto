...
<body class="bg-primary">
  ...
  <section class="py-5 mt-3 container">
    <a href="ingreso1_contenido.php?id3=<?php echo $_GET['id']?>"> <button type="button" class="btn btn-dark"> Ingresar Contenidos </button>  </a>
  </section>
        ...
        foreach ($productos as $producto) { ?>
          ...
          <div class="jumbotron py-3">
            ...
            <p class="lead text-center">
              <a class="btn btn-primary btn-lg" href="materia_admin.php?id2=<?php echo $producto['id_materia'] ?>"> ACCEDER</a>
            </p>
            <hr class="my-2">
